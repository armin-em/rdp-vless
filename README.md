...
v
+-------------------------------------------------------------------+
| Layer 1: X.224 Connection Request / Confirm Negotiation (Port 3389)|
+-------------------------------------------------------------------+
|
v
+-------------------------------------------------------------------+
| Layer 2: TLS Upgrade (TLS 1.2 / 1.3 with RDP SAN certificates)   |
+-------------------------------------------------------------------+
|
v
+-------------------------------------------------------------------+
| Layer 3: CredSSP Handshake (ASN.1 BER / NTLMSSP Frame Synthetic)  |
+-------------------------------------------------------------------+
|
v
+-------------------------------------------------------------------+
| Layer 4: MCS Control Sequence (Erect Domain, Attach User, Join)   |
+-------------------------------------------------------------------+
|
v
+-------------------------------------------------------------------+
| Layer 5: RDP Session Handshake (Client Info, Demand/Confirm)      |
+-------------------------------------------------------------------+
|
v
+-------------------------------------------------------------------+
| Layer 6: Virtual Channel Framing + UUID Masked VLESS Proxy Header |
+-------------------------------------------------------------------+
